...
elif set(("SECRET_KEY", "RECAPTCHA_PUBLIC_KEY", "RECAPTCHA_PRIVATE_KEY")).issubset(environ.keys()):
...
3. website/secret.py file with the same content as in 1.""", file=stderr)
        exit(1)
