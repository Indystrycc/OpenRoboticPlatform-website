...
!function() {
    ...
    var z = c, L = l, M = (z.document, !L.documentElement || !L.head || "function" != typeof L.addEventListener || L.createElement, 
    ~s.indexOf("MSIE") || s.indexOf("Trident/"), "classic"), a = {
        fak: "kit",
        "fa-kit": "kit"
    }, e = {
        fakd: "kit-duotone",
    ...
    const u = z || {};
    u[L] || (u[L] = {}), u[L].styles || (u[L].styles = {}), u[L].hooks || (u[L].hooks = {}), 
    u[L].shims || (u[L].shims = []);
    var p = u[L];
    function g(z) {
    ...
    function b(c, l, s) {
        var {
            skipHooks: z = !1
        } = 2 < arguments.length && void 0 !== s ? s : {}, s = g(l);
        "function" != typeof p.hooks.addPack || z ? p.styles[c] = {
            ...p.styles[c] || {},
            ...s
        } : p.hooks.addPack(c, g(l)), "fas" === c && b("fa", l);
    }
    var w = {
